...
Requires: rabbitmq-server >= 1.7.2, python-boss-skynet > 0.6.0, rubygem-ruote > 2.1.10, rubygem-ruote-amqp, rubygem-yajl-ruby, rubygem-inifile, rubygem-amqp >= 0.9.0, rubygem-tzinfo
%description
